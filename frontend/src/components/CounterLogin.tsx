    ...
    return (
        <div className="container mt-2">
            ...
            <div className="logBody w-100">
                <h2 className="log mt-5 mb-3">Counter Login</h2>
                ...
                <form onSubmit={handleLogin} className="w-100 flex-grow-1 d-flex flex-column justify-content-center align-items-center">
                    <div className="mb-3 row">
                        <label className="form-label" htmlFor="counterusername">Username:</label>
                        <input
                            id="counterusername"
                            type="text"
                    ...
                    <div className="mb-3 row">
                        <label className="form-label" htmlFor="counterpassword">Password:</label>
                        <input 
                            id="counterpassword"
                            type="password"
